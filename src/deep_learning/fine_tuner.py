...
class FineTuner:
    ...
    def Experiment(self, dataset_type, experiment_name, test_split=["Test"]):
        # Fine-tune the model
        ...
        combined_csv_path = f"/home/ec2-user/madde/experiments/results/{experiment_name}_{dataset_type}_{self.model_name}_combined_report.csv"
